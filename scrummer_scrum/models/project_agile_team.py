...
class ScrumTeam(models.Model):
    ...
    velocity = fields.Integer(string="Velocity",)

    sprint_sequence = fields.Integer(string="Sprint Sequence", default=1)
    ...
    active_sprint_count = fields.Integer(
        string="Active Sprint Count", compute="_compute_active_sprint_count",
    )

    future_sprint_count = fields.Integer(
        string="Future Sprint Count", compute="_compute_future_sprint_count",
    )
